...
Inaccurate Numeric Literal (CWE-197 - Numeric Truncation Error)
--- 
...
Unreachable Code (CWE-561 - Dead Code) 
--- 
...
Use Base with ParseInt (CWE-474 - Use of Function with Inconsistent Implementations)
---
